...
$(function() {
	...
	$("select[name='fontsize']").val('<?php functions::try_get($_COOKIE, 'fontsize', $fontsize, '16');
    echo $fontsize; ?>');
    $("select[name='fontname']").val('<?php functions::try_get($_COOKIE, 'fontname', $fontname, 'Arial');
    echo $fontname; ?>');
    $("input[name='topColor']").val('<?php functions::try_get($_COOKIE, 'topColor', $topColor, '#FFFFF9');
    echo $topColor; ?>');
    $("input[name='botColor']").val('<?php functions::try_get($_COOKIE, 'botColor', $botColor, '#F9FFF9');
    echo $botColor; ?>');
    $("input[name='forceBottom']").prop('checked', <?php functions::try_get($_COOKIE, 'forceBottom', $forceBottom, '0');
    echo ($forceBottom == '1' ? 'true' : 'false'); ?>);
});
